...
var notip_init = function (config) {
    const rover = {
        ...
        nav_tuning: {
            two_wheel_yaw_filter_alpha: config.nav_tuning && typeof config.nav_tuning.two_wheel_yaw_filter_alpha === 'number' ? config.nav_tuning.two_wheel_yaw_filter_alpha : 0.2,
