...
var notip_init = function (config) {
    ...
    white_rabbit.white_rabbit_memory.init(white_rabbit, {
    ...
    if (white_rabbit.learning_config.enabled) {
        white_rabbit.white_rabbit_learning.init(white_rabbit);
    }
    ...
    white_rabbit.white_rabbit_recall.init(white_rabbit);
    ...
    white_rabbit.white_rabbit_journey.init(white_rabbit);
    ...
    white_rabbit.white_rabbit_heart.init(white_rabbit);
    ...
    white_rabbit.cpu_monitor.init(white_rabbit);
    ...
    white_rabbit.memory_monitor.init(white_rabbit);
    ...
    white_rabbit.disk_monitor.init(white_rabbit);
    ...
    white_rabbit.white_rabbit_autonomous.init(white_rabbit);
    ...
    white_rabbit.rc_observer_module.init(white_rabbit);
    ...
    white_rabbit.white_rabbit_intelligence.init(white_rabbit);
    ...
    if (white_rabbit.voice_config.enabled) {
        white_rabbit.white_rabbit_voice.init(white_rabbit);
    }
