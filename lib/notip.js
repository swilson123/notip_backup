    ...
    const rover = {
        ...
        realsense:{
            ...
            vision: {
                ...
                correction_gain_deg_per_meter: config.realsense_vision && typeof config.realsense_vision.correction_gain_deg_per_meter === 'number' ? config.realsense_vision.correction_gain_deg_per_meter : 8,
                ...
                max_steering_offset_deg: config.realsense_vision && typeof config.realsense_vision.max_steering_offset_deg === 'number' ? config.realsense_vision.max_steering_offset_deg : 10,
                ...
                object_min_height_m: config.realsense_vision && typeof config.realsense_vision.object_min_height_m === 'number' ? config.realsense_vision.object_min_height_m : 0.05,
