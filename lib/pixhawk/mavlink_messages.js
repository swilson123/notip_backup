...
mavlink_messages.prototype.GPS_RTCM_DATA = function(white_rabbit, flags, length, data)
{
/*
...
*/
    ...
    var request = new white_rabbit.mavlink.messages.gps_rtcm_data(flags, length, data);
...
mavlink_messages.prototype.GPS_INJECT_DATA = function(white_rabbit, length, data)
{
/*
GPS_INJECT_DATA ( #123 )
...
*/
    ...
    var request = new white_rabbit.mavlink.messages.gps_inject_data(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, length, data);
...
mavlink_messages.prototype.MAV_CMD_DO_SET_SERVO = function(white_rabbit, data)
{
/*
...
*/
    ...
    var request = new white_rabbit.mavlink.messages.command_long(
        white_rabbit.pixhawk_port.targetSystem, 
        white_rabbit.pixhawk_port.targetComponent, 
        white_rabbit.mavlink.MAV_CMD_DO_SET_SERVO, 
        1, 
...
mavlink_messages.prototype.PARAM_SET = function(white_rabbit, data)
{
    var request = new white_rabbit.mavlink.messages.param_set(
        white_rabbit.pixhawk_port.targetSystem, 
        white_rabbit.pixhawk_port.targetComponent, 
        data.param_id,
        data.param_value,
...
mavlink_messages.prototype.MAV_CMD_DO_SET_RELAY = function(white_rabbit, data)
{
/*
...
*/
	...
	var request = new white_rabbit.mavlink.messages.command_long(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, white_rabbit.mavlink.MAV_CMD_DO_SET_RELAY, 1, data.param1, data.param2, 0, data.param4, data.param5, data.param6, data.param7);
...
mavlink_messages.prototype.MISSION_COUNT = function(white_rabbit, data)
{


	var request = new white_rabbit.mavlink.messages.mission_count(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, data.count);
...
mavlink_messages.prototype.MISSION_WRITE_PARTIAL_LIST = function(white_rabbit, data)
{

	var request = new white_rabbit.mavlink.messages.mission_write_partial_list(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, data.start_index, data.end_index);
...
mavlink_messages.prototype.MISSION_SET_CURRENT = function(white_rabbit, data)
{


	var request = new white_rabbit.mavlink.messages.mission_set_current(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, data.seq);
...
mavlink_messages.prototype.MISSION_REQUEST_LIST = function(white_rabbit)
{


	var request = new white_rabbit.mavlink.messages.mission_request_list(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent);
...
mavlink_messages.prototype.MISSION_REQUEST = function(white_rabbit, data)
{


	var request = new white_rabbit.mavlink.messages.mission_request(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, data.seq);
...
mavlink_messages.prototype.MISSION_ITEM = function(white_rabbit, data)
{


	var request = new white_rabbit.mavlink.messages.mission_item(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, data.seq, data.frame, data.command, data.current, data.autocontinue, data.param1, data.param2, data.param3, data.param4, data.param5, data.param6, data.param7);
...
mavlink_messages.prototype.REQUEST_DATA_STREAM = function(white_rabbit, data)
{


	var request = new white_rabbit.mavlink.messages.request_data_stream(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, data.req_stream_id, data.req_message_rate, data.start_stop);
...
mavlink_messages.prototype.SET_POSITION_TARGET_LOCAL_NED = function(white_rabbit, data)
{
...
*/
	...
	var request = new white_rabbit.mavlink.messages.set_position_target_local_ned(data.time_usec, white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, data.frame, data.type_mask, data.x, data.y, data.z, data.vx, data.vy, data.vz, data.afx, data.afy, data.afz, data.yaw, data.yaw_rate);
...
mavlink_messages.prototype.SET_POSITION_TARGET_GLOBAL_INT = function(white_rabbit, data)
{
...
*/
	...
	var request = new white_rabbit.mavlink.messages.set_position_target_global_int(data.time_usec, white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, data.frame, data.type_mask, data.lat_int, data.lon_int, data.alt, data.vx, data.vy, data.vz, data.afx, data.afy, data.afz, data.yaw, data.yaw_rate);
...
mavlink_messages.prototype.SET_ATTITUDE_TARGET = function(white_rabbit, data)
{
...
*/
	...
	var request = new white_rabbit.mavlink.messages.set_attitude_target(Date.now(), white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, '0b00000000', data.quaternion, data.body_roll_rate, data.body_pitch_rate, data.body_yaw_rate, data.thrust);
...
mavlink_messages.prototype.MAV_CMD_MISSION_START = function(white_rabbit)
{
...
*/
	...
	var request = new white_rabbit.mavlink.messages.command_long(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, white_rabbit.mavlink.MAV_CMD_MISSION_START, 1, 0, 0, 0, 0, 0, 0, 0);
...
mavlink_messages.prototype.MAV_CMD_DO_CHANGE_SPEED = function(white_rabbit, data)
{
...
*/
	...
	var request = new white_rabbit.mavlink.messages.command_long(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, white_rabbit.mavlink.MAV_CMD_COMPONENT_ARM_DISARM, 1, data.param1, 0, 0, 0, 0, 0, 0);
...
mavlink_messages.prototype.MAV_CMD_COMPONENT_ARM_DISARM = function(white_rabbit, data)
{
...
mavlink_messages.prototype.MAV_CMD_NAV_WAYPOINT = function(white_rabbit, data)
{

/*
MAV_CMD_NAV_WAYPOINT  Navigate to the specified position.
Mission Param #1  Hold time at mission waypoint in decimal seconds - MAX 65535 seconds. (Copter/White_rabbit only)
Mission Param #2  Empty
Mission Param #3  Empty
Mission Param #4  Empty
...
*/
	...
	if (data.param5 && data.param6)
	{
		...
		request = new white_rabbit.mavlink.messages.command_long(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, white_rabbit.mavlink.MAV_CMD_NAV_WAYPOINT, 1, data.param1, 0, 0, 0, parseInt(data.param5 * 10000000), parseInt(data.param6 * 10000000), data.param7);
...
mavlink_messages.prototype.MAV_CMD_NAV_TAKEOFF = function(white_rabbit, data)
{
...
*/
	...
	var request = new white_rabbit.mavlink.messages.command_long(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, white_rabbit.mavlink.MAV_CMD_NAV_TAKEOFF, 1, 0, 0, 0, 0, 0, 0, data.param7);
...
mavlink_messages.prototype.MAV_CMD_NAV_LOITER_UNLIM = function(white_rabbit, data)
{
...
*/
	...
	var request = new white_rabbit.mavlink.messages.command_long(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, white_rabbit.mavlink.MAV_CMD_NAV_LOITER_UNLIM, 1, 0, 0, 0, 0, data.param5, data.param6, data.param7);
...
mavlink_messages.prototype.MAV_CMD_NAV_LOITER_TURNS = function(white_rabbit, data)
{
...
*/
	...
	var request = new white_rabbit.mavlink.messages.command_long(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, white_rabbit.mavlink.MAV_CMD_NAV_TAKEOFF, 1, data.param1, 0, 0, 0, data.param5, data.param6, data.param7);
...
mavlink_messages.prototype.MAV_CMD_NAV_LOITER_TIME = function(white_rabbit, data)
{
...
mavlink_messages.prototype.COMMAND_LONG = function(white_rabbit, data)
{
...
*/
	...
	var request = new white_rabbit.mavlink.messages.command_long(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, data.command, data.confirmation, data.param1, data.param2, data.param3, data.param4, data.param5, data.param6, data.param7);
...
mavlink_messages.prototype.MAV_CMD_NAV_GUIDED_ENABLE = function(white_rabbit, data)
{
...
*/
	...
	var request = new white_rabbit.mavlink.messages.command_long(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, white_rabbit.mavlink.MAV_CMD_NAV_GUIDED_ENABLE, 1, data.param1, 0, 0, 0, 0, 0, 0);
...
mavlink_messages.prototype.MAV_CMD_NAV_LAND = function(white_rabbit, data)
{
...
*/
	...
	if (data.param5 && data.param6)
	{
		...
		request = new white_rabbit.mavlink.messages.command_long(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, white_rabbit.mavlink.MAV_CMD_NAV_LAND, 1, data.param1, data.param2, 0, data.param4, data.param5, data.param6, data.param7);
...
mavlink_messages.prototype.LANDING_TARGET = function(white_rabbit, data)
{


	var request = new white_rabbit.mavlink.messages.landing_target(data.time_usec, data.target_num, data.frame, data.angle_x, data.angle_y, data.distance, data.size_x, data.size_y)
	var status_message = 'LANDING_TARGET: updated';

	return [status_message, request];
};

mavlink_messages.prototype.MAV_CMD_CONDITION_DELAY = function(white_rabbit, data)
{
...
*/
	...
	var request = new white_rabbit.mavlink.messages.command_long(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, white_rabbit.mavlink.MAV_CMD_CONDITION_DELAY, 1, data.param1, 0, 0, 0, 0, 0, 0);
...
mavlink_messages.prototype.MAV_CMD_CONDITION_CHANGE_ALT = function(white_rabbit, data)
{
...
*/
	...
	var request = new white_rabbit.mavlink.messages.command_long(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, white_rabbit.mavlink.MAV_CMD_CONDITION_CHANGE_ALT, 1, data.param1, 0, 0, 0, 0, 0, data.param7);
...
mavlink_messages.prototype.MAV_CMD_CONDITION_DISTANCE = function(white_rabbit, data)
{
...
*/
	...
	var request = new white_rabbit.mavlink.messages.command_long(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, white_rabbit.mavlink.MAV_CMD_CONDITION_DISTANCE, 1, data.param1, 0, 0, 0, 0, 0, 0);
...
mavlink_messages.prototype.MAV_CMD_DO_CHANGE_ALTITUDE = function(white_rabbit, data)
{
...
*/
	...
	var request = new white_rabbit.mavlink.messages.command_long(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, white_rabbit.mavlink.MAV_CMD_DO_CHANGE_ALTITUDE, 1, data.param1, data.param2, 0, 0, 0, 0, 0);
...
mavlink_messages.prototype.MAV_CMD_CONDITION_YAW = function(white_rabbit, data)
{
	...
	if (data.param1)
	{
		request = new white_rabbit.mavlink.messages.command_long(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, white_rabbit.mavlink.MAV_CMD_CONDITION_YAW, 1, data.param1, data.param2, data.param3, data.param4, 0, 0, 0);
...
mavlink_messages.prototype.MAV_CMD_DO_SET_HOME = function(white_rabbit, data)
{
...
*/
	...
	if (data.param5 && data.param6)
	{
		request = new white_rabbit.mavlink.messages.command_long(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, white_rabbit.mavlink.MAV_CMD_DO_SET_HOME, 1, data.param1, 0, 0, 0, data.param5, data.param6, data.param7);
...
mavlink_messages.prototype.MAV_CMD_NAV_RETURN_TO_LAUNCH = function(white_rabbit)
{
...
*/
	...
	var request = new white_rabbit.mavlink.messages.command_long(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, white_rabbit.mavlink.MAV_CMD_NAV_RETURN_TO_LAUNCH, 1, 0, 0, 0, 0, 0, 0, 0);
...
mavlink_messages.prototype.MAV_CMD_DO_SET_MODE = function(white_rabbit, data)
{
...
*/
	...
	var request = new white_rabbit.mavlink.messages.command_long(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, white_rabbit.mavlink.MAV_CMD_DO_SET_MODE, 1, data.param1, data.param2, data.param3, 0, 0, 0, 0);
...
mavlink_messages.prototype.SET_MODE = function(white_rabbit, data)
{
...
*/
	...
	var request = new white_rabbit.mavlink.messages.set_mode(data.param1, data.param2, data.param3);
...
*/
	...
	var request = new white_rabbit.mavlink.messages.command_long(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent, white_rabbit.mavlink.MAV_CMD_DO_CHANGE_SPEED, 1, 0, data.param2, 0, 0, 0, 0, 0);
...
mavlink_messages.prototype.MISSION_CLEAR_ALL = function(white_rabbit)
{

	var request = new white_rabbit.mavlink.messages.mission_clear_all(white_rabbit.pixhawk_port.targetSystem, white_rabbit.pixhawk_port.targetComponent);
	...
	mavlink_messages.prototype.RC_CHANNELS_OVERRIDE = function(white_rabbit, data)
	{
		// CORRECT - Use the proper rc_channels_override message
		var request = new white_rabbit.mavlink.messages.rc_channels_override(
			white_rabbit.pixhawk_port.targetSystem, 
			white_rabbit.pixhawk_port.targetComponent, 
			data.chan1_raw, 
			data.chan2_raw, 
...
mavlink_messages.prototype.SERVO_OUTPUT_RAW = function(white_rabbit, data)
{
/*
SERVO_OUTPUT_RAW ( #36 )
...
*/
    ...
    var request = new white_rabbit.mavlink.messages.servo_output_raw(
        time_usec,
        port,
        data.servo1_raw || 0,
        data.servo2_raw || 0,
...
mavlink_messages.prototype.ACTUATOR_CONTROL_TARGET = function(white_rabbit, data)
{
/*
...
*/
    ...
    var request = new white_rabbit.mavlink.messages.actuator_control_target(
        time_usec,
        group,
        controls
    );
...
mavlink_messages.prototype.MANUAL_CONTROL = function(white_rabbit, data)
{
/*
MANUAL_CONTROL ( #69 )
...
*/
    ...
    var request = new white_rabbit.mavlink.messages.manual_control(
        white_rabbit.pixhawk_port.targetSystem,
