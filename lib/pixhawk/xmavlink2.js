...
Generated from: AVSSUAS.xml,common.xml,standard.xml,minimal.xml
...
// number.
mavlink20.MAV_CMD_DO_GIMBAL_MANAGER_PITCHYAW = 1000; // High level setpoint to be sent to a gimbal manager to set a gimbal
...
mavlink20.MAV_CMD_PRS_GET_BATTERY = 60052; // AVSS defined command.  Get the PRS battery voltage in millivolts
mavlink20.MAV_CMD_PRS_GET_ERR = 60053; // AVSS defined command. Get the PRS error statuses.
mavlink20.MAV_CMD_PRS_SET_ARM_ALTI = 60070; // AVSS defined command. Set the ATS arming altitude in meters.
mavlink20.MAV_CMD_PRS_GET_ARM_ALTI = 60071; // AVSS defined command. Get the ATS arming altitude in meters.
mavlink20.MAV_CMD_PRS_SHUTDOWN = 60072; // AVSS defined command. Shuts down the PRS system.
mavlink20.MAV_CMD_ENUM_END = 60073; //

// MAV_AVSS_COMMAND_FAILURE_REASON
mavlink20.PRS_NOT_STEADY = 1; // AVSS defined command failure reason. PRS not steady.
mavlink20.PRS_DTM_NOT_ARMED = 2; // AVSS defined command failure reason. PRS DTM not armed.
mavlink20.PRS_OTM_NOT_ARMED = 3; // AVSS defined command failure reason. PRS OTM not armed.
mavlink20.MAV_AVSS_COMMAND_FAILURE_REASON_ENUM_END = 4; //

// AVSS_M300_OPERATION_MODE
mavlink20.MODE_M300_MANUAL_CTRL = 0; // In manual control mode
mavlink20.MODE_M300_ATTITUDE = 1; // In attitude mode
mavlink20.MODE_M300_P_GPS = 6; // In GPS mode
mavlink20.MODE_M300_HOTPOINT_MODE = 9; // In hotpoint mode
mavlink20.MODE_M300_ASSISTED_TAKEOFF = 10; // In assisted takeoff mode
mavlink20.MODE_M300_AUTO_TAKEOFF = 11; // In auto takeoff mode
mavlink20.MODE_M300_AUTO_LANDING = 12; // In auto landing mode
mavlink20.MODE_M300_NAVI_GO_HOME = 15; // In go home mode
mavlink20.MODE_M300_NAVI_SDK_CTRL = 17; // In sdk control mode
mavlink20.MODE_M300_S_SPORT = 31; // In sport mode
mavlink20.MODE_M300_FORCE_AUTO_LANDING = 33; // In force auto landing mode
mavlink20.MODE_M300_T_TRIPOD = 38; // In tripod mode
mavlink20.MODE_M300_SEARCH_MODE = 40; // In search mode
mavlink20.MODE_M300_ENGINE_START = 41; // In engine mode
mavlink20.AVSS_M300_OPERATION_MODE_ENUM_END = 42; //

// AVSS_HORSEFLY_OPERATION_MODE
mavlink20.MODE_HORSEFLY_MANUAL_CTRL = 0; // In manual control mode
mavlink20.MODE_HORSEFLY_AUTO_TAKEOFF = 1; // In auto takeoff mode
mavlink20.MODE_HORSEFLY_AUTO_LANDING = 2; // In auto landing mode
mavlink20.MODE_HORSEFLY_NAVI_GO_HOME = 3; // In go home mode
mavlink20.MODE_HORSEFLY_DROP = 4; // In drop mode
mavlink20.AVSS_HORSEFLY_OPERATION_MODE_ENUM_END = 5; //
...
// MAV_CMD_ACK
mavlink20.MAV_CMD_ACK_OK = 0; // Command / mission item is ok.
mavlink20.MAV_CMD_ACK_ERR_FAIL = 1; // Generic error message if none of the other reasons fails or if no
// detailed error reporting is implemented.
mavlink20.MAV_CMD_ACK_ERR_ACCESS_DENIED = 2; // The system is refusing to accept this command from this source /
// communication partner.
mavlink20.MAV_CMD_ACK_ERR_NOT_SUPPORTED = 3; // Command or mission item is not supported, other commands would be
// accepted.
mavlink20.MAV_CMD_ACK_ERR_COORDINATE_FRAME_NOT_SUPPORTED = 4; // The coordinate frame of this command / mission item is not supported.
mavlink20.MAV_CMD_ACK_ERR_COORDINATES_OUT_OF_RANGE = 5; // The coordinate frame of this command is ok, but he coordinate values
// exceed the safety limits of this system.
// This is a generic error, please use the
// more specific error messages below if
// possible.
mavlink20.MAV_CMD_ACK_ERR_X_LAT_OUT_OF_RANGE = 6; // The X or latitude value is out of range.
mavlink20.MAV_CMD_ACK_ERR_Y_LON_OUT_OF_RANGE = 7; // The Y or longitude value is out of range.
mavlink20.MAV_CMD_ACK_ERR_Z_ALT_OUT_OF_RANGE = 8; // The Z or altitude value is out of range.
mavlink20.MAV_CMD_ACK_ENUM_END = 9; //
...
mavlink20.MAV_AUTOPILOT_ARDUPILOTMEGA = 3; // ArduPilot - Plane/Copter/White_rabbit/Sub/Tracker, https://ardupilot.org
...
mavlink20.MAV_TYPE_GROUND_ROVER = 10; // Ground white_rabbit
...
mavlink20.MAVLINK_MSG_ID_AVSS_DRONE_OPERATION_MODE = 60053;
...
AVSS PRS system status.
                ...
                time_boot_ms              : Timestamp (time since PRS boot). (uint32_t)
                error_status              : PRS error statuses (uint32_t)
                battery_status            : Estimated battery run-time without a remote connection and PRS battery voltage (uint32_t)
                arm_status                : PRS arm statuses (uint8_t)
...
Drone position.
                ...
                time_boot_ms              : Timestamp (time since FC boot). (uint32_t)
                ...
                ground_alt                : Altitude above ground, This altitude is measured by a ultrasound, Laser rangefinder or millimeter-wave radar (float)
...
Drone operation mode.
                ...
                time_boot_ms              : Timestamp (time since FC boot). (uint32_t)
                M300_operation_mode        : DJI M300 operation mode (uint8_t)
...
SET_MISSION_CURRENT.
                ...
                seq                       : Sequence (uint16_t)
                total                     : Total number of mission items. 0: Not supported, UINT16_MAX if no mission is present on the vehicle. (uint16_t)
...
transmitted as individual on/off bits of a bitmask
                ...
                enabled_extensions        : Set bits to 1 to indicate which of the following extension fields contain valid data: bit 0: pitch, bit 1: roll. (uint8_t)
...
*/
mavlink20.messages.manual_control = function (target, x, y, z, r, buttons, buttons2, enabled_extensions, s, t) {
	this.format = '<hhhhHBHBhh';
	this.id = mavlink20.MAVLINK_MSG_ID_MANUAL_CONTROL;
	this.order_map = [5, 0, 1, 2, 3, 4, 6, 7, 8, 9];
	this.crc_extra = 243;
	this.name = 'MANUAL_CONTROL';

	this.fieldnames = ['target', 'x', 'y', 'z', 'r', 'buttons', 'buttons2', 'enabled_extensions', 's', 't'];
...
mavlink20.messages.manual_control.prototype.pack = function (mav) {
	return mavlink20.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [this.x, this.y, this.z, this.r, this.buttons, this.target, this.buttons2, this.enabled_extensions, this.s, this.t]));
};
...
over COMMAND_LONG when sending positional data in params 5 and 6, as
it allows for greater precision when sending latitudes/longitudes.
Param 5 and 6 encode positional data as scaled integers, where the
scaling depends on the actual command value. NaN or INT32_MAX may be
used in float/integer params (respectively) to indicate
optional/default values (e.g. to use the component's current latitude,
yaw rather than a specific value). The command microservice is
...
generally preferred when sending MAV_CMD commands where param 5 and
param 6 contain latitude/longitude data, as sending these in floats
can result in a significant loss of precision. COMMAND_LONG is
required for commands that mandate float values in params 5 and 6. The
...
https://mavlink.io/en/services/command.html
                ...
                progress                  : Also used as result_param1, it can be set with an enum containing the errors reasons of why the command was denied, or the progress percentage when result is MAV_RESULT_IN_PROGRESS (UINT8_MAX if the progress is unknown). (uint8_t)
...
*/
mavlink20.messages.gimbal_device_information = function (time_boot_ms, vendor_name, model_name, custom_name, firmware_version, hardware_version, uid, cap_flags, custom_cap_flags, roll_min, roll_max, pitch_min, pitch_max, yaw_min, yaw_max) {
	this.format = '<QIIIffffffHH32s32s32s';
	this.id = mavlink20.MAVLINK_MSG_ID_GIMBAL_DEVICE_INFORMATION;
	this.order_map = [1, 12, 13, 14, 2, 3, 0, 10, 11, 4, 5, 6, 7, 8, 9];
	this.crc_extra = 74;
	this.name = 'GIMBAL_DEVICE_INFORMATION';

	this.fieldnames = ['time_boot_ms', 'vendor_name', 'model_name', 'custom_name', 'firmware_version', 'hardware_version', 'uid', 'cap_flags', 'custom_cap_flags', 'roll_min', 'roll_max', 'pitch_min', 'pitch_max', 'yaw_min', 'yaw_max'];
...
mavlink20.messages.gimbal_device_information.prototype.pack = function (mav) {
	return mavlink20.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [this.uid, this.time_boot_ms, this.firmware_version, this.hardware_version, this.roll_min, this.roll_max, this.pitch_min, this.pitch_max, this.yaw_min, this.yaw_max, this.cap_flags, this.custom_cap_flags, this.vendor_name, this.model_name, this.custom_name]));
};
...
relative to the vehicle heading (vehicle frame).            If the
flag GIMBAL_DEVICE_FLAGS_YAW_IN_EARTH_FRAME is set, then they are
relative to absolute North (earth frame).            If neither of
these flags are set, then (for backwards compatibility) it holds:
If the flag GIMBAL_DEVICE_FLAGS_YAW_LOCK is set, then they are
relative to absolute North (earth frame),            else they are
relative to the vehicle heading (vehicle frame).            Setting
both GIMBAL_DEVICE_FLAGS_YAW_IN_VEHICLE_FRAME and
...
If the flag GIMBAL_DEVICE_FLAGS_YAW_LOCK is set, then they are
relative to absolute North (earth frame),            else they are
relative to the vehicle heading (vehicle frame).            Other
conditions of the flags are not allowed.            The quaternion and
angular velocities in the other frame can be calculated from delta_yaw
and delta_yaw_velocity as            q_earth = q_delta_yaw * q_vehicle
and w_earth = w_delta_yaw_velocity + w_vehicle (if not NaN).
...
*/
mavlink20.messages.gimbal_device_attitude_status = function (target_system, target_component, time_boot_ms, flags, q, angular_velocity_x, angular_velocity_y, angular_velocity_z, failure_flags, delta_yaw, delta_yaw_velocity) {
	this.format = '<I4ffffIHBBff';
	this.id = mavlink20.MAVLINK_MSG_ID_GIMBAL_DEVICE_ATTITUDE_STATUS;
	this.order_map = [7, 8, 0, 6, 1, 2, 3, 4, 5, 9, 10];
	this.crc_extra = 137;
	this.name = 'GIMBAL_DEVICE_ATTITUDE_STATUS';

	this.fieldnames = ['target_system', 'target_component', 'time_boot_ms', 'flags', 'q', 'angular_velocity_x', 'angular_velocity_y', 'angular_velocity_z', 'failure_flags', 'delta_yaw', 'delta_yaw_velocity'];
...
mavlink20.messages.gimbal_device_attitude_status.prototype.pack = function (mav) {
	return mavlink20.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [this.time_boot_ms, this.q, this.angular_velocity_x, this.angular_velocity_y, this.angular_velocity_z, this.failure_flags, this.flags, this.target_system, this.target_component, this.delta_yaw, this.delta_yaw_velocity]));
};
...
mavlink20.map = {
	...
	60053: { format: '<IBB', type: mavlink20.messages.avss_drone_operation_mode, order_map: [0, 1, 2], crc_extra: 45 },
	...
	69: { format: '<hhhhHBHBhh', type: mavlink20.messages.manual_control, order_map: [5, 0, 1, 2, 3, 4, 6, 7, 8, 9], crc_extra: 243 },
	...
	283: { format: '<QIIIffffffHH32s32s32s', type: mavlink20.messages.gimbal_device_information, order_map: [1, 12, 13, 14, 2, 3, 0, 10, 11, 4, 5, 6, 7, 8, 9], crc_extra: 74 },
	284: { format: '<4ffffHBB', type: mavlink20.messages.gimbal_device_set_attitude, order_map: [5, 6, 4, 0, 1, 2, 3], crc_extra: 99 },
	285: { format: '<I4ffffIHBBff', type: mavlink20.messages.gimbal_device_attitude_status, order_map: [7, 8, 0, 6, 1, 2, 3, 4, 5, 9, 10], crc_extra: 137 },
