...
var carrot_data_filter = function (white_rabbit) {
    ...
    var had_left_edge = white_rabbit.realsense.path_detection.edge_left_conf >= _conf_thresh;
    var had_right_edge = white_rabbit.realsense.path_detection.edge_right_conf >= _conf_thresh;
    ...
    var alpha = (white_rabbit.realsense.vision_full && typeof white_rabbit.realsense.vision_full.carrot_bias_alpha === 'number')
        ? white_rabbit.realsense.vision_full.carrot_bias_alpha : 0.02;
    ...
    var _bias_cap_m = (white_rabbit.realsense.vision_full && typeof white_rabbit.realsense.vision_full.carrot_bias_cap_m === 'number')
        ? white_rabbit.realsense.vision_full.carrot_bias_cap_m : 0.2;
