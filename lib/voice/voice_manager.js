...
var white_rabbit_voice = function (white_rabbit) {
    ...
    const LOW_BATTERY_REPEAT_MS = typeof cfg.low_battery_repeat_ms === 'number' ? cfg.low_battery_repeat_ms : 60000;
    ...
    const battery_monitor = setInterval(() => {
        ...
        if (volts < LOW_BATTERY_V) {
            if (now - last_low_battery_say >= LOW_BATTERY_REPEAT_MS) {
                ...
                speak_announcement('Low battery. ' + volts.toFixed(1) + ' volts remaining.');
            }
        } else {
