...
function init(rover) {
    rover.heart = {
        ...
        feel() {
            ...
            return { confidence, caution, presence, warmth, tenderness, commitment, anticipation, joy, balance, intent };
        },
        ...
        guide() {
            ...
            const confidence_lift   = (f.confidence - 0.5) * 0.20 * f.balance;   // ±0.10, gated by balance
            ...
            const should_pause = f.presence < 0.3;
