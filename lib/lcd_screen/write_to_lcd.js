...
async function draw_realsense(screen, white_rabbit, opts) {
    ...
    // Raw steering angle straight from sidewalk_vision.py (pre-correction/pre-smoothing;
    // compare against the A: field on row 3, which is the final commanded angle).
    ...
    // 20-char rows:
    // Row 0: "ANGLE: +12.3"        (raw x_angle_deg from sidewalk_vision.py)
