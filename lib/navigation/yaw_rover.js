var yaw_rover = function (rover, degrees, motor_speed_cmd) {
	...
	rover.servo_send_command(rover, 11, 1750, false);

	rover.servo_send_command(rover, 12, 1750, false);
	rover.servo_send_command(rover, 13, 1750, false);
	rover.servo_send_command(rover, 14, 1750, false);
	setTimeout(() => {
