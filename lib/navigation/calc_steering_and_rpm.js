var calc_steering_and_rpm = function (white_rabbit, steering_angle_deg, base_rpm) {
    ...
    if (angle === 0) {
        return {
            ...
            motor_rpm: {
                front_driver: rpm,
                back_driver: rpm,
                front_passenger: rpm * -1,
                back_passenger: rpm * -1
            }
        };
    }
    ...
    const back_left_angle = turn_left ? inner_angle : -outer_angle;
    const back_right_angle = turn_left ? outer_angle : -inner_angle;
    ...
    return {
        servo_angles_deg: {
            ...
            back_driver: back_left_angle * -1,
            front_passenger: front_right_angle,
            back_passenger: back_right_angle * -1
        },
        motor_rpm: {
            front_passenger: driver_rpm * -1,
            back_passenger: driver_rpm * -1,
            front_driver: passenger_rpm,
            back_driver: passenger_rpm 
        }
    };
};
