        ...
        if (rover.mission.path_clear) {
            ...
            if (waypoint.latitude && waypoint.longitude) {
                ...
                if (Math.abs(rover.robot_data.yaw_to_waypoint) > 25 || distance_to_waypoint_meters < 1 && Math.abs(rover.robot_data.yaw_to_waypoint) > 5) {
                    ...
                    if (rover.motor.current_steering_type == "two_wheels") {
                        ...
                        setTimeout(() => {
                            rover.move_rover(rover, 1, motor_speed_cmd * -1, "run_mission");
                        }, 10);
                        setTimeout(() => {
                            rover.move_rover(rover, 4, motor_speed_cmd, "run_mission");
                        }, 20);
                        setTimeout(() => {
                            rover.move_rover(rover, 3, motor_speed_cmd, "run_mission");
                        }, 30);
                        setTimeout(() => {
                            rover.move_rover(rover, 2, motor_speed_cmd * -1, "run_mission");
                        }, 40);
                    }
                }
