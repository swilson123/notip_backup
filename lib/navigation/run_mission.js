                    ...
                    if (mission_yaw_should_run) {
                        ...
                        if (white_rabbit.motor.current_steering_type == "four_wheels") {
                            ...
                            if (Math.abs(white_rabbit.robot_data.yaw_to_waypoint) > 25) {
                                ...
                                if (!_follow_sw) {
                                    // Follow-sidewalk disabled: never enter seeking and stay quiet.
                                    nc.sidewalk_seeking = false;
                                    nc.sidewalk_seek_enter_ts = null;
                                    nc.sidewalk_seek_exit_ts = null;
                                } else if (!nc.sidewalk_seeking) {
                                    if (seek_want_enter) {
                                ...
                                let path_heading_bias_deg = _follow_sw ? (_path_correction_dir * _path_heading_deg * _path_heading_gain * vision_scale) : 0;
