var down_the_rabbit_hole = function (white_rabbit) {
    if (white_rabbit.robot_data.is_armed) {
        ...
        if (!white_rabbit.dock.dock_state) {
            ...
            var on_ramp_long_enough = white_rabbit.dock.ramp_started_at && (Date.now() - white_rabbit.dock.ramp_started_at > 3000);
            ...
            white_rabbit.create_arduino_message(white_rabbit, 'telescope', 0);
