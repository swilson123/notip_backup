var undock_white_rabbit = function (white_rabbit) {
    if (white_rabbit.robot_data.is_armed) {
        ...
        if (!white_rabbit.dock.dock_state) {
            ...
            // The white rabbit is in Wonderland.....If a full mission was requested via the RC undock switch, start it now.
            if (white_rabbit.dock.start_mission_after_undock && !white_rabbit.robot_data.mission_mode) {
                if (!white_rabbit.rc_contoller || !white_rabbit.rc_contoller.connected) {
