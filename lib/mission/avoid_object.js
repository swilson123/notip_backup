var avoid_object = function (rover) {
	...
	const FRONT_CLEAR_STABLE_MS = 700;
	const RESUME_CORRIDOR_STABLE_MS = 1200;
	const RESUME_FRONT_CLEARANCE_MM = 1200;
	const AVOIDANCE_TURN_YAW = 30;
	const AVOIDANCE_TURN_SPEED = 35;
	...
	if (front_clear_stable && corridor_stable) {
