var avoid_object = function (rover) {
	...
	const CREEP_CLEARANCE_DISTANCE_M = 0.457;
	...
	function stop_white_rabbit() {
		...
		rover.move_white_rabbit(rover, 1, 0, "avoid_object");
		rover.move_white_rabbit(rover, 2, 0, "avoid_object");
		rover.move_white_rabbit(rover, 3, 0, "avoid_object");
		rover.move_white_rabbit(rover, 4, 0, "avoid_object");
	...
	function move_forward_slowly() {
		...
		if (rover.servos.motor_front_driver.set_pwm > 1400 && rover.servos.motor_front_driver.set_pwm < 1600 &&
			...
			rover.move_white_rabbit(rover, 1, AVOIDANCE_CREEP_SPEED * -1, "avoid_object");
			rover.move_white_rabbit(rover, 4, AVOIDANCE_CREEP_SPEED, "avoid_object");
			rover.move_white_rabbit(rover, 3, AVOIDANCE_CREEP_SPEED, "avoid_object");
			rover.move_white_rabbit(rover, 2, AVOIDANCE_CREEP_SPEED * -1, "avoid_object");
		}
	}
	...
	if (front_blocked) {
		...
		rover.yaw_white_rabbit(rover, yaw_command, AVOIDANCE_TURN_SPEED);
		return;
	}
