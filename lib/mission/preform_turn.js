var preform_turn = function (white_rabbit, degrees) {
    return new Promise(function(resolve, reject) {

        white_rabbit.set_flight_mode(white_rabbit, 'Manual');
        ...
        function setNextParam() {
            ...
            var param_response = white_rabbit.mavlink_messages.PARAM_SET(white_rabbit, param_data);
            white_rabbit.send_pixhawk_command(white_rabbit, param_response[0], param_response[1], null);
        ...
        function startTurn() {
            ...
            // Get current heading
            var start_heading = white_rabbit.robot_data.ATTITUDE ? (white_rabbit.robot_data.ATTITUDE.yaw * 180 / Math.PI) : 0;
            ...
            function performTurn() {
                ...
                // Get current heading
                var current_heading = white_rabbit.robot_data.ATTITUDE ? (white_rabbit.robot_data.ATTITUDE.yaw * 180 / Math.PI) : start_heading;
                ...
                if (aggressive_phase && !has_overshot) {
                    ...
                    if (heading_change < 2.0 && elapsed_time > 3) {
                        console.log('White_rabbit stuck in aggressive phase - MAX POWER!');
                    ...
                    if (heading_change < 1.0 && error_abs > yaw_tolerance && elapsed_time > 10) {
                        console.log('White_rabbit not turning in precision phase - boosting power');
            ...
            function sendServoCommand(servo_num, pwm_value) {
                ...
                var servo_response = white_rabbit.mavlink_messages.MAV_CMD_DO_SET_SERVO(white_rabbit, servo_data);
                white_rabbit.send_pixhawk_command(white_rabbit, servo_response[0], servo_response[1], null);
            }
