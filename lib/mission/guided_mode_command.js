var guided_mode_command = function(white_rabbit, x, y, z, yaw) {
    ...
    function sendYawCommand() {
        ...
        if (yaw) {
            ...
            var yaw_degrees = white_rabbit.get_heading(white_rabbit) + yaw;
        ...
        var data = {
            time_usec: Date.now(),
            frame: white_rabbit.guided_mode_command_robot.mav_frame,
            ...
            afz: null,
            yaw: yaw,
            yaw_rate: white_rabbit.guided_mode_command_robot.yaw_rate
        };

        var mav_response = white_rabbit.mavlink_messages.SET_POSITION_TARGET_LOCAL_NED(white_rabbit, data);
