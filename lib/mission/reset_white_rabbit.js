var reset_white_rabbit = function (white_rabbit) {
	...
	// Clear the auto_delivery edge tracker so a reset mid-delivery can't leave a
	// stale "1" that fires a false 1->0 completion edge on the next mission.
	white_rabbit.arduino.last_auto_delivery = false;
