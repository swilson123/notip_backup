...
var create_logs = function (rover) {
	...
	rover.logs.connect_to_waveshare = new rover.logging(rover, 'connect_to_waveshare');
	rover.logs.waveshare_message_handler = new rover.logging(rover, 'waveshare_message_handler');
	rover.logs.arduino_message_handler = new rover.logging(rover, 'arduino_message_handler');
	rover.logs.realsense_message_handler = new rover.logging(rover, 'realsense_message_handler');
	rover.logs.sidewalk_detection = new rover.logging(rover, 'sidewalk_detection');
	rover.logs.run_mission = new rover.logging(rover, 'run_mission');
	rover.logs.intelligence = new rover.logging(rover, 'intelligence');
	rover.logs.avoid_object = new rover.logging(rover, 'avoid_object');
	rover.logs.lidar_message_filter = new rover.logging(rover, 'lidar_message_filter');
	rover.logs.imu = new rover.logging(rover, 'imu');
	rover.logs.irlock = new rover.logging(rover, 'irlock');
