...
// Motors 1,2 at +speed → white_rabbit moves toward dock.
...
var follow_the_light = function (white_rabbit) {
    ...
    if (!state.phase) {
        ...
        white_rabbit.logs.irlock.log(white_rabbit, 'follow_the_light: starting — ref_pitch=' + state.ref_pitch.toFixed(2));
