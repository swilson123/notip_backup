...
function start_realsense_vision(white_rabbit) {
	...
	let vision_config = {
		...
		// Static camera mount tilt (degrees, positive = pitched forward / nose-down). Added
		// to the rover's dynamic body pitch so the depth->ground projection knows the camera's
		// true angle to the ground.
		camera_mount_pitch_deg: typeof vision.camera_mount_pitch_deg === 'number' ? vision.camera_mount_pitch_deg : 0,
