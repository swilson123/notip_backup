...
var arduino_message_handler = function (white_rabbit, data) {
	...
	try {
		...
		//hook limit switch..............................
		if (white_rabbit.arduino.received_data.hook_switch_state == 0 && !white_rabbit.robot_data.mission_mode) {
		...
		else if (white_rabbit.arduino.received_data.hook_switch_state == 0
