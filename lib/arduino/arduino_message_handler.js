...
var arduino_message_handler = function (white_rabbit, data) {
	...
	try {
		...
		//hook limit switch..............................
		if (white_rabbit.arduino.received_data.hook_switch_state && white_rabbit.dock.dock_state == "undocked_completed") {
		...
		else if (white_rabbit.arduino.received_data.hook_switch_state
