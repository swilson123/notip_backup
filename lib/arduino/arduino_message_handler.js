...
var arduino_message_handler = function (white_rabbit, data) {
	...
	try {
		...
		if (white_rabbit.arduino.received_data.auto_delivery == 0 && white_rabbit.mission.auto_delivery) {
			...
			if (white_rabbit.arduino.received_data.belt_extend_switch_state == 0 && white_rabbit.claw.rc_claw > 1900 && white_rabbit.arduino.belt_extend_switch_state == 1 && white_rabbit.arduino.received_data.auto_delivery == 0) {
			white_rabbit.mission.auto_delivery = true;
			white_rabbit.arduino.belt_extend_switch_state = white_rabbit.arduino.received_data.belt_extend_switch_state;
